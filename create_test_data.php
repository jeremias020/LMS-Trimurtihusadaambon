...
try {
    ...
    // Get or create a practical
    $practical = \App\Models\Practical::where('guru_id', $guruId)->first();
    if (!$practical) {
        echo "❌ No practical found for this guru!" . PHP_EOL;
        exit;
    }
    
    echo "✅ Practical found: " . $practical->judul . PHP_EOL;
