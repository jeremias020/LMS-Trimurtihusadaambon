<header class="top-header">
    ...
    <form id="globalSearchForm" class="d-none d-md-block" method="GET" action="#">
        <div class="input-group" style="min-width: 360px;">
            ...
            <input id="globalSearch" type="text" class="form-control border-start-0" placeholder="Cari materi, tugas, siswa...">
        </div>
    </form>
    ...
    <div class="d-flex align-items-center gap-3">
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                <li><a class="dropdown-item" href="{{ route('guru.profile.edit') }}"><i class="fas fa-user-cog me-2"></i>Profil</a></li>
                <li><hr class="dropdown-divider"></li>
                <li>
