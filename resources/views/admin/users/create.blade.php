...
<div class="mb-6">
    ...
    <p class="text-gray-600">Tambahkan pengguna baru ke dalam sistem LMS SMK Kesehatan Trimurti Husada Ambon</p>
</div>
...
<div class="bg-white rounded-lg shadow overflow-hidden">
    <div class="px-6 py-4 border-b border-gray-200">
        <h2 class="text-xl font-semibold text-gray-800">Form Tambah Pengguna</h2>
    </div>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" class="form-input" value="{{ $oldName }}" required>
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email" id="email" class="form-input" value="{{ $oldEmail }}" required>
                        @error('email')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" name="phone" id="phone" class="form-input" value="{{ $oldPhone }}"
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="nip" id="nip" class="form-input" value="${oldNip}" required>
                                @error('nip')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="nis" id="nis" class="form-input" value="${oldNis}" required>
                                @error('nis')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <select name="class" id="class" class="form-input" required>
                                    ...
                                    <option value="X Keperawatan" ${oldClass === 'X Keperawatan' ? 'selected' : ''}>X Keperawatan</option>
                                    <option value="XI Keperawatan" ${oldClass === 'XI Keperawatan' ? 'selected' : ''}>XI Keperawatan</option>
                                    <option value="XII Keperawatan" ${oldClass === 'XII Keperawatan' ? 'selected' : ''}>XII Keperawatan</option>
                                    <option value="X Farmasi" ${oldClass === 'X Farmasi' ? 'selected' : ''}>X Farmasi</option>
                                    <option value="XI Farmasi" ${oldClass === 'XI Farmasi' ? 'selected' : ''}>XI Farmasi</option>
                                    <option value="XII Farmasi" ${oldClass === 'XII Farmasi' ? 'selected' : ''}>XII Farmasi</option>
                                </select>
                                @error('class')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="birth_date" id="birth_date" class="form-input" value="${oldBirthDate}" required max="{{ date('Y-m-d') }}">
                                @error('birth_date')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <textarea name="address" id="address" class="form-input" rows="3" required>${oldAddress}</textarea>
                                @error('address')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
