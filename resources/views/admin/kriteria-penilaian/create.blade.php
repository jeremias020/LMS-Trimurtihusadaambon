        ...
        <div class="col-xl-8 col-lg-10">
            <div class="card">
                <div class="card-header bg-primary text-white d-flex align-items-center">
                    ...
                    <h5 class="mb-0">Tambah Kriteria Penilaian</h5>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('admin.kriteria-penilaian.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="number" name="bobot" step="0.01" min="0" max="1" value="{{ old('bobot', 0.10) }}" class="form-control @error('bobot') is-invalid @enderror" required>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="deskripsi" rows="3" class="form-control @error('deskripsi') is-invalid @enderror" placeholder="Deskripsi singkat kriteria">{{ old('deskripsi') }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <div id="checklistContainer" class="mt-2">
                                @php
                                    $oldChecklist = old('sop_checklist', ['']);
                                @endphp
