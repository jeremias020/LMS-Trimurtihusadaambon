...
<div class="container-fluid px-0">
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-body p-3 p-md-4">
            <div class="d-flex align-items-center mb-2 mb-md-0">
                <div class="bg-primary rounded-circle d-flex align-items-center justify-content-center me-3" style="width:48px;height:48px; overflow:hidden;">
                    @php
        ...
        <div class="col-6 col-lg-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="flex-grow-1">
                        <h3 class="mb-0 fw-bold">{{ $stats['completed_assignments'] ?? 0 }}</h3>
        ...
        <div class="col-6 col-lg-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="flex-grow-1">
                        <h3 class="mb-0 fw-bold">{{ $stats['completed_practicals'] ?? 0 }}</h3>
                        <div class="text-muted small">Praktikum Selesai</div>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-6 col-lg-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="flex-grow-1">
                        <h3 class="mb-0 fw-bold">{{ $stats['average_score'] ?? 0 }}</h3>
    ...
    <div class="row g-3 g-md-4 mb-4">
        <div class="col-6 col-md-3">
            <a href="{{ route('siswa.materials.index') }}" class="btn btn-primary w-100 h-100 d-flex flex-column align-items-center justify-content-center p-3">
                <i class="fas fa-book fa-2x mb-2"></i>
                <span>Lihat Materi</span>
            </a>
        </div>
        <div class="col-6 col-md-3">
            <a href="{{ route('siswa.assignments.index') }}" class="btn btn-warning w-100 h-100 d-flex flex-column align-items-center justify-content-center p-3">
                <i class="fas fa-tasks fa-2x mb-2"></i>
                <span>Tugas</span>
            </a>
        </div>
        <div class="col-6 col-md-3">
            <a href="{{ route('siswa.praktikum.index') }}" class="btn btn-success w-100 h-100 d-flex flex-column align-items-center justify-content-center p-3">
                <i class="fas fa-flask fa-2x mb-2"></i>
                <span>Praktikum</span>
            </a>
        </div>
        <div class="col-6 col-md-3">
            <a href="{{ route('siswa.nilai.index') }}" class="btn btn-info w-100 h-100 d-flex flex-column align-items-center justify-content-center p-3">
