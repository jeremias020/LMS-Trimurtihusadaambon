...
echo "=== CHECK EXISTING SKILL_LEVEL VALUES ===" . PHP_EOL;
$existing = DB::table('practicals')->select('skill_level')->distinct()->get();
foreach ($existing as $row) {
    echo "- '" . $row->skill_level . "' (length: " . strlen($row->skill_level) . ")" . PHP_EOL;
}

echo PHP_EOL . "=== ADDING PRACTICAL WITH EXISTING SKILL_LEVEL ===" . PHP_EOL;
...
// Add the missing practical with existing skill_level value
$practical = [
    ...
    'skill_level' => 'Menengah', // Use existing value
